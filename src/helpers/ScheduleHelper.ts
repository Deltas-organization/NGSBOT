...
export class ScheduleHelper {
    ...
    public static SanitizeCasterURL(match: INGSSchedule) {
        const twitchIndex = match.casterUrl?.toLowerCase().indexOf("twitch");
        const youtubeIndex = match.casterUrl?.toLowerCase().indexOf("youtube");
        if (twitchIndex >= 0) {
